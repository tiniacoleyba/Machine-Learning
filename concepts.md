...
The ideal data scientist (DS) would know three core technical pillars in depth: mathematics, software engineering, and his particular business area. So, DS is a cross-disciplinary role. A world-class data scientist must be excellent in each of those pillars but not necessarily as good as a person who focuses only on one of the pillars. For example, a DS is not expected to be better than a mathematician in mathematics but is certainly expected to know some fields in depth, such as statistics.

## Concepts and keywords
Random variable, TensorFlow, PyTorch, MLlib, MLFlow, MLOps, neural network (NN), 
...
variance, standard error of the mean, sequence, Law of Large Numbers (LoL),
...
expected remaining lifetime, power, statistical significance, p-value, credible intervals,
...
algorithm complexity, function, method, class, bootstrap, weighted bootstrapping, LifeLines, PyMC,
...
Markov Chains, Markov Chain Monte Carlo methods (MCMC), Numba, Numpy, Pandas, Python,
...
correlation, causation,  intervention, quasi-experimental design, experimenta design, 
...
odds, logarithm, logarithmic scale, boxplot, violin plot, calendar plot, dashboard, chart, KPI,
...
propensity score, type I error, type II error, false positive, false negative, sample size determination,
Minimum Detectable Effect (MDE), t-student distribution, degrees of freedom, critical value, tail,
hypothesis, reject, simulation, programming, ruptured Python library (Change Point Detection),
...
Sigma, Design, Designer, Dark software Pattern, logical bug, syntax error, scientific article, LaTeX,
Mathematical formulas, Data Visualization (DataViz), ETL, parallelization, cluster, node, orchestration,
