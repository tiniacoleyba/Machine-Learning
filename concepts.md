...
evolutionary algorithms, surrogate model, Finite Element Method (FEM), Ordinary Differential Equation (ODE),
...
class size paradox, percentile rank, quartile skewness, confounder, counterfactual,
proportional growth results in log-normal distribution, sympy (Symbolic Python Math),
additive growth resulst in normal distribution, integral, integration, differentiation,
decile plot, causal inference, rank correlation, Spearman's Rank correlation coefficient,
longitudinal study, robust estimator, consistent estimator,